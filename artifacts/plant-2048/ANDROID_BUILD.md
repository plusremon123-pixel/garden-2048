...
# 2. 웹앱 빌드 + Android 동기화
pnpm --filter @workspace/plant-2048 android:sync

# 3. Android Studio 실행
pnpm --filter @workspace/plant-2048 android:open
```

### 방법 2: plant-2048 디렉토리에서 직접

```bash
cd artifacts/plant-2048
...
```ts
// artifacts/plant-2048/capacitor.config.ts
{
  appId: 'com.plant2048.app',    // 앱 패키지 ID
  appName: 'Plant 2048',          // 앱 이름
